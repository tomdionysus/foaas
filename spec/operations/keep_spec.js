...
describe('/keep', function () {
  ...
  return describe('register', function () {
    ...
    return it('should call output with correct params', function () {
      ...
      const message = `${req.params.name}: fork off. And when you get there, fork off from there too. Then fork off some more. Keep fucking off until you get back here. Then fork off again.`
