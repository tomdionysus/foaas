...
describe "/greed", ->
  it "should have the correct noun", ->
    expect(operation.noun).toEqual('Greed')
  ...
  describe 'register', ->
    ...
    it 'should call output with correct params', ->
      ...
      message = """The point is, ladies and gentleman, that #{req.params.noun} -- for lack of a better word -- is good. #{req.params.noun} is right. #{req.params.noun} works. #{req.params.noun} clarifies, cuts through, and captures the essence of the evolutionary spirit. #{req.params.noun}, in all of its forms -- #{req.params.noun} for life, for money, for love, knowledge -- has marked the upward surge of mankind."""
